...
func RegisterGamesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GamesServer) error {
	...
	mux.Handle("POST", pattern_Games_CreateGame_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/game_service.v1.Games/CreateGame", runtime.WithHTTPPathPattern("/api/v1/game"))
		if err != nil {
...
// "GamesClient" to call the correct interceptors.
func RegisterGamesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GamesClient) error {
	...
	mux.Handle("POST", pattern_Games_CreateGame_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/game_service.v1.Games/CreateGame", runtime.WithHTTPPathPattern("/api/v1/game"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Games_CreateGame_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "game"}, ""))
)
